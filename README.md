...
| [**RAG**](https://github.com/rjayswal-pythonista/RAG) | Retrieval-Augmented Generation — vector DBs, advanced RAG, SQL RAG, PDF RAG, evaluation & AWS deployment | `Python` `LangChain` `Pinecone` `FAISS` |
